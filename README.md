...
- Get docker
  ...
  - Windows: Human readable: [docs.docker.com](https://docs.docker.com/desktop/setup/install/windows-install/)
```
...
```
You should now be able to access the widget at https://localhost:5000 via most javascript enabled browsers.
